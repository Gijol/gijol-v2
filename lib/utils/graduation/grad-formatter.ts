/* 졸업요건 세부 정보 관련 함수들
 * getPercentage - 최소 학점으로 퍼센트 값 생성
 * extractOverallStatus - overall 화면에 맞게 변환해주는 함수
 * getDomainColor - 영역 색 처리 
 *  // TODO: 파싱된 결과 처리 과정에서 영역별 색깔을 넘겨줘도 좋을듯
 * getFeedbackNumbers - 피드백 수 관련 함수
 * createSpecificStatusMessage - 퍼센트에 따른 메세지 생성 함수
 * getStatusColor - 이수 여부에 따른 색
 * getStatusMessage - 이수 여부에 따른 메세지 생성
*/
