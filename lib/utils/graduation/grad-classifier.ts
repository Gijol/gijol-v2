...
// 언어 기초 (영어, 글쓰기)
const LANGUAGE_BASIC_CODES = new Set([
  'GS1601',
  'GS1602',
  'GS1603',
  'GS1604',
...
const SCIENCE_BASIC_CODES = new Set([
  'GS1001', // 미적분학과 응용
  'GS1101', // 일반물리학 및 연습 I
  'GS1103', // 일반물리학 및 연습 II (코드 변경 대응)
  'GS1111', // 일반물리학 실험 I
  'GS1201', // 일반화학 및 연습 I
  'GS1203', // 일반화학 및 연습 II (코드 변경 대응)
  'GS1301', // 생물학
  'GS1302', // 인간 생물학
  'GS1303', // 생물학 (코드 변경 대응)
  'GS1311', // 일반생물학 실험
...
const THESIS_SUFFIXES = ['9102', '9103']; // 학사논문연구 I, II 등
